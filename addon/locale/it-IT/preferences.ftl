...
pref-interface-fontSize-hint =
    .value = Suggerimento: tieni premuto Ctrl/Cmd e scorri sul testo tradotto per ridimensionarlo.
pref-interface-showPopupFontSizeControls =
    .label = Popup del lettore: mostra il riquadro "Text Font"
